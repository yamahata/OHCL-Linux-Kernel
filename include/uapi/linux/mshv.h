...
#define MSHV_CAP_VENDOR_SHIFT		24
#define MSHV_CAP_VENDOR_MASK		GENMASK(31, 24)
#define MSHV_CAP_VENDOR_TDX		(1 << MSHV_CAP_VENDOR_SHIFT)
#define MSHV_CAP_TDX_TSC_DEADLINE	(MSHV_CAP_VENDOR_TDX | 0x1)
